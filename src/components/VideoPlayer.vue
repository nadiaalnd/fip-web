...
export default {
  ...
  methods: {
    ...
    onPlayerTimeupdate () {
      ...
      if ((duration != 0 && duration <= currentTime) || (this.lastTime !== currentTime && currentTime % 5 === 0)) {
    ...
    reportProduct () {
      ...
      this.$services.product.updateProgress(this.report_data, (data) => {
        this.$emit('updatePercentage', this.report_data.pointer, this.report_data.duration)
      }, (msg, error) => {
        console.log(msg)
      }, () => {
