<template>
  <q-page class="q-pb-md">
      ...
      <div class="container row flex-center q-px-md">
        <div class="flex-1 q-py-md banner-title">
          ...
          <p
            ...
            v-html="
              $utils.replaceEnter(setting[$route.meta.storageKey + ' Subtitle'])
            "
          ></p>
        </div>
      </div>
    ...
    <DialogIFrame v-model="iframeDialog.dialog" :iframe="iframeDialog.iframe" />
  </q-page>
</template>
<script>
...
export default {
  meta() {
    let title = this.setting
      ? this.$utils.replaceEnter(
          this.setting[this.$route.meta.storageKey + " Title"]
        )
      : "Finplan";
    let description = this.setting
      ? this.$utils.replaceEnter(
          this.setting[this.$route.meta.storageKey + " Subtitle"]
        )
      : "Finplan";
